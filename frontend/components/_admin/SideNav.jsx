...
import { menuList } from '../../services/adminMenuService'; 
import { useUserDetails } from '../../hooks/useUserDetails';
import { handleLogout } from '../../services/authService';

/**
 * Komponen SideNav
 * Menangani tampilan navigasi samping untuk admin.
 * 
        ...
        <div className='border shadow-md min-h-screen p-5 flex flex-col'>
            ...
            <div className='mt-auto flex gap-2 items-center'>
                {userDetails?.photoURL ? (
                    ...
                    <Avatar name={userDetails?.email} size="35" round={true} />
                )}
                {userDetails ? (
                    <div className='flex items-center relative'>
                        <div>
                            <h2 className='text-sm font-bold'>Admin : {userDetails.name}</h2>
